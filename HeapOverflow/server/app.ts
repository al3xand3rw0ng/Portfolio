...
import userNotificationController from './controller/userNotification';
...
app.use('/friendship', friendshipController(socket));
app.use('/message', messageController(socket));
app.use('/notification', userNotificationController(socket));
